...
st.title("About Your Mate")

st.markdown("""
Your TravelMate is a web application that generates a travel plan based on Large-Language Models (LLMs). It helps users create personalized itineraries giving the best destinations, activities, and routes.
